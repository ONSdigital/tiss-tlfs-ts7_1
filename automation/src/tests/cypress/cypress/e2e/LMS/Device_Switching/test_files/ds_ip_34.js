...
var dev_switch_filename = Cypress.env('survey_version') + '_' + Cypress.env('survey_environment') + '_ip34_dev_switch.csv'
/*----------------------------------------------------------------------------------------------------------------
Script: HH1
Open Defects:
...
describe('LMB Online IP34 -  Device Switching', function () {
  it('IP34 Device Switching Start', function() {
    //initialise sts
    ...
    //Type GUID
      ...
      framework("cypress/" + rel_path + "tsv_files/IP34_LMS_England_Start.tsv", "en", "lms", false);

    });
  });//End of first part of test

  it('IP34 Device Switching Finish', function() {
    //initialise sts
    //func.check_sts();
    ...
    framework("cypress/" + rel_path + "tsv_files/IP34_LMS_England_Finish.tsv", "en", "lms", false, "No", "");
